...
<div className="order_table_header">
   ...
   <button className="pth_export_btn mr-3">
       <span>High speed printing label history</span> 
       <KeyboardArrowDownIcon/>
    </button>

   <button className="pth_export_btn">
       <span>Export</span> 
       <KeyboardArrowDownIcon/>
    </button>
    </div>
...
<div className="order_table_tab">
  ...
  >
      <span className="mr-2 text-gray-700">Not printed</span>
      <div className="ott_badge">0</div>
  </button>
  <button className={`${TableTab==='own'?'active':''}`}
  onClick={e=>setTableTab('own')}
  >
      <span className="mr-2 text-gray-700">AWB number empty</span>
      <div className="ott_badge">0</div>
  </button>
</div>
...
export default PendingPrintTable
...
<div className="order_table_header">
   <div className="pth_tab_button">
       <button className="active text-gray-700">Pending (0)</button>
       <button className="text-gray-700">Problem Order (0)</button>
       <button className="text-gray-700">Failed (0)</button>
   </div>
   <div>

...
const StoreSaleReport=():ReactElement =>{
...
<div>
  ...
  <div className="px-5 py-3 flex items-center">
      <span className="text-gray-700 text-sm w-12">Store : </span> 
      ...
      <div className="form-check ml-16 mr-2">
      <input className="form-check-input  h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-indigo-100 checked:border-blue-600 focus:outline-none transition duration-200 my-1 align-top bg-no-repeat bg-center bg-contain float-left cursor-pointer" type="checkbox" value="" id="flexCheckDefault3"/>
      </div>
      <span className="text-gray-700 text-sm w-32">MANUAL SHOP</span>
      </div>
  </div>  

  <div className="p-2 px-5 flex items-center ps_sm_col">
   ...
   <div className="py-2 px-5 flex items-center ps_sm_col">
     <span className="text-sm text-gray-700 w-20">Short By :</span>
...
export default StoreSaleReport